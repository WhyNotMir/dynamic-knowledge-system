...
class ProposalKind(str, enum.Enum):
    # `initial` = first proposal for a project (create-article dominant).
    # `incremental_update` = 2nd+ document, generated by Phase 7 Routing;
    # the Inbox shows a summary like "3 append, 2 merge, 2 create_article".
    INITIAL = "initial"
