...
class ArticleCandidate(Base):
    ...
    fragment_ids:        Mapped[list]        = mapped_column(JSON, nullable=False)   # list[str] uuid strings
    status:              Mapped[CandidateStatus] = mapped_column(Enum(CandidateStatus), default=CandidateStatus.PROPOSED, nullable=False)
