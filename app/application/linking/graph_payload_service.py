...
class GraphPayloadError(RuntimeError):
    """Base error for graph payload operations."""


class ProjectNotFoundError(GraphPayloadError):
    """Raised when a project does not exist."""


async def get_project_graph_payload(
